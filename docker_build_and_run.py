...
os.system(f"docker run --publish 8000:5000 --env POSTGRES_USER={POSTGRES_USER} --env POSTGRES_PASSWORD={POSTGRES_PASSWORD} --env POSTGRES_DB={POSTGRES_DB} etl_image")
